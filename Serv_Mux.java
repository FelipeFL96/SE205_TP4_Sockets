...
public class Serv_Mux {
    ...
    public static void main(String[] args) throws java.io.IOException, java.net.SocketException {
		Thread Tab_Threads [];
		int j, Port, Nbre_Standard, Nbre_Serv_TCP, Nbre_Threads = 0;
		
		// Verification des arguments passes sur la ligne de commande
		if (args.length != 3) {
			System.out.println("Arguments : nbre-threads nbre-serveurs-TCP num-premier-port");
			System.exit(1);
		}
